...
{
    [Serializable]
    internal class Strategy_If_Float : StrategyGraphNode_Base
    {
        ...
        protected override void OnDefineOptions(IOptionDefinitionContext context)
        {
            context.AddOption<GoapConditionOp>(OptionOperator)
                ...
                .WithDefaultValue(GoapConditionOp.GreaterOrEqual);
        }
        ...
        protected override void OnDefinePorts(IPortDefinitionContext context)
        {
            ...
            var valueAPort = context.AddInputPort<float>(ValueAPortName)
                .WithDisplayName("A")
                .WithConnectorUI(PortConnectorUI.Circle)
                .Build();

            var valueBPort = context.AddInputPort<float>(ValueBPortName)
                .WithDisplayName("B")
                .WithConnectorUI(PortConnectorUI.Circle)
                .Build();
